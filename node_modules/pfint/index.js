...
exports.sync = function sync(config, state)
{
	var net = require('net');
	state.update(
	...
	var client = net.connect({host: config['host'], port: config['port']},
		function() { //'connect' listener
			...
			client.on('data', function(data) {
				...
				{
					console.log("##PF MemorySlot seen")
...
function resync(state, connection)
{
	...
	if (nextCommand)
	{
		...
		console.log("No next command, queueing up some more")
		// requery all routers
